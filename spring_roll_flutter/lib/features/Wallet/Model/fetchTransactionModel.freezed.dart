...
class _$TransactionModelImpl implements _TransactionModel {
  ...
  @override
  String toString() {
    return 'TransactionModel(id: $id, senderName: $senderName, receiverName: $receiverName, amount: $amount, timestamp: $timestamp, statement: $statement, status: $status, transactionRole: $transactionRole, phoneNumber: $phoneNumber)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, senderName, receiverName,
      amount, timestamp, statement, status, transactionRole, phoneNumber);
