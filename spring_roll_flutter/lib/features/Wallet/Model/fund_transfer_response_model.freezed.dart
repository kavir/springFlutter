...
class _$FundTransferResponseModelImpl implements _FundTransferResponseModel {
  ...
  @override
  String toString() {
    return 'FundTransferResponseModel(status: $status, message: $message, amount: $amount, serviceChargeAmount: $serviceChargeAmount, discountAmount: $discountAmount, receiverName: $receiverName, receiverNumber: $receiverNumber)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, status, message, amount,
      serviceChargeAmount, discountAmount, receiverName, receiverNumber);
