...
import 'package:spring_roll_flutter/features/Wallet/Provider/fetchRewardPoints.dart';
...
import 'package:spring_roll_flutter/features/Wallet/Screen/ElectricityScreen.dart';
import 'package:spring_roll_flutter/features/Wallet/Screen/editUserProfile.dart';
import 'package:spring_roll_flutter/features/Wallet/Screen/fun_transfer_screen.dart';
import 'package:spring_roll_flutter/features/Wallet/Screen/transaction_history_screen.dart';
    ...
    ref.listen(fundTransferProvider, (previous, next) {
      next.maybeMap(
        ...
        error: (e) {
          ...
          ToastUtils().showErrorToast(context,e.data!.message );
        },
      );
    });
            ...
            Row(
              children: [
                ...
                TextButton(onPressed: (){
                  ref.read(tokenStorageProvider.notifier).deleteToken();
                  ref.read(phoneNumberProvider.notifier).deletePhoneNumber();
                }, child: Text("Logout"))
              ],
            ),
          ],
