...
abstract class $LoginRequestModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic number, dynamic password});
}
...
class _$LoginRequestModelImpl implements _LoginRequestModel {
  const _$LoginRequestModelImpl({this.number, this.password});
  ...
  @override
  String toString() {
    return 'LoginRequestModel(number: $number, password: $password)';
  }
...
abstract class _LoginRequestModel implements LoginRequestModel {
  const factory _LoginRequestModel(
      {final dynamic number, final dynamic password}) = _$LoginRequestModelImpl;
