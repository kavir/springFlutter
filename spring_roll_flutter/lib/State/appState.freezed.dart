...
abstract class Initial<T> implements AppState<T> {
...
class _$LoadingImpl<T> implements Loading<T> {
  const _$LoadingImpl({this.loading});
...
abstract class Loading<T> implements AppState<T> {
  const factory Loading({final bool? loading}) = _$LoadingImpl<T>;
...
abstract class Error<T> implements AppState<T> {
  const factory Error({final T? data}) = _$ErrorImpl<T>;
...
class __$$LoginErrorImplCopyWithImpl<T, $Res>
    extends _$AppStateCopyWithImpl<T, $Res, _$LoginErrorImpl<T>>
...
abstract class LoginError<T> implements AppState<T> {
  const factory LoginError({final String? errorMessage}) = _$LoginErrorImpl<T>;
